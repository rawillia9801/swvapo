...
// SAME BUYER LOOKUP FLOW AS /portal/mypuppy
try {
...
// app lookup can stay independent for application summary/status
try {
...
// SAME PUPPY LOOKUP FLOW AS /portal/mypuppy
if (buyer?.id) {
...
// pupdates: do not show future events
if (puppy?.id) {
try {
...
? `Match Confirmed: ${data?.puppy?.call_name || data?.puppy?.puppy_name || data?.puppy?.name || "Your Puppy"}`
: hasApp

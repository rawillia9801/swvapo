  ...
  if (hasPuppy) {
    return [
      ...
      },
      {
        icon: "🐾",
        title: "View My Puppy",
        desc: "See your puppy’s profile, milestones, and updates.",
        href: "/portal/mypuppy",
        cta: "Open My Puppy",
      },
      {
...
export default function PortalPage() {
  ...
  const heroDesc = hasPuppy
    ? "You’re matched. Review documents, check your puppy profile, and keep an eye on Messages for updates."
    : hasApp
  ...
  const greetingName = hasPuppy
    ? `${data?.puppy?.call_name || data?.puppy?.puppy_name || data?.puppy?.name || "Puppy"}'s Family`
            ...
            <div className="flex flex-col lg:flex-row lg:items-end justify-between gap-5">
              <div>
                ...
                <p className="mt-2 text-brand-500 font-semibold">
                  Everything in one place — application, messages, documents, and your puppy
                  profile.
                </p>
              </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
              ...
              <div className="card-luxury p-7 bg-gradient-to-br from-[#FFFBF0] to-white border-brand-200 relative overflow-hidden">
                ...
                <p className="font-serif text-xl italic text-brand-800 mb-4 leading-relaxed">
                  “Your portal keeps your puppy journey organized in one place.”
                </p>
                ...
                {hasPuppy ? (
                  ...
                  <div className="card-luxury p-12 text-center border-dashed border-2 border-brand-200">
                    ...
                    <p className="text-brand-500 mt-3 max-w-md mx-auto text-sm font-semibold leading-relaxed">
                      Once your application is approved and a match is made, your puppy’s
                      profile, photos, and details will appear here automatically.
                    </p>
                  ...
                  <div className="mt-5 space-y-3">
                    ...
                    <div className="p-4 rounded-2xl bg-white/65 border border-brand-200">
                      ...
                      <div className="mt-1 text-sm font-semibold text-brand-800 leading-relaxed">
                        For the most accurate balances and receipts, always use the Financials
                        page.
                      </div>
                    </div>

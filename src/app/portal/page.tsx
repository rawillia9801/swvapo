    ...
    <div className="space-y-6 pb-14">
        ...
        aside={
          <div className="grid gap-4">
            <PortalInfoTile
              ...
              detail={
                puppy
                  ? `${puppyStage} on this account.`
                  : "Your account is active and waiting for a linked puppy profile."
              }
            ...
            <PortalInfoTile
              ...
              detail={
                remaining && remaining > 0
                  ? "Current balance remaining on file."
      ...
      <PortalMetricGrid>
        ...
        <PortalMetricCard
          ...
          detail={
            unreadBreederMessages
              ? `${unreadBreederMessages} breeder message${unreadBreederMessages === 1 ? "" : "s"} unread.`
              : "No unread breeder replies."
          }
        ...
        <PortalMetricCard
          ...
          detail={
            state.pickupRequest
              ? requestTypeLabel(state.pickupRequest)
              ...
              <div className="grid gap-5">
                <div className="grid gap-4 md:grid-cols-2">
                  ...
                  <PortalInfoTile
                    ...
                    detail={
                      state.payments[0]
                        ? fmtMoney(state.payments[0].amount)
                        : "Payment history will appear as soon as it is recorded."
                    }
                ...
                <div className="rounded-[28px] border border-[var(--portal-border)] bg-[linear-gradient(180deg,rgba(255,255,255,0.98)_0%,rgba(243,248,253,0.95)_100%)] p-5 shadow-[0_14px_30px_rgba(23,35,56,0.05)]">
                  ...
                  <div className="mt-5 flex flex-wrap gap-3">
                    <PortalHeroPrimaryAction href="/portal/mypuppy">
                      Open My Puppy
                    </PortalHeroPrimaryAction>
                    <PortalHeroSecondaryAction href="/portal/updates">
                      Open Pupdates
                    </PortalHeroSecondaryAction>
                  </div>
                </div>
            ...
            <div className="grid gap-4">
              ...
              <PortalInfoTile
                ...
                detail={
                  state.pickupRequest
                    ? requestTypeLabel(state.pickupRequest)
                    : "No transportation request recorded yet."
                }
